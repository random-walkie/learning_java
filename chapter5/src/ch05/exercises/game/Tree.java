...
public class Tree implements GamePiece {
    ...
    // Drawing helpers
    private final Color leafColor = Color.GREEN.darker();
    private final Color trunkColor = new Color(101, 67, 33);
    private final int trunkWidth = (int)(Field.TREE_WIDTH_IN_PIXELS * 0.2);
    private final int trunkHeight = (int)(Field.TREE_WIDTH_IN_PIXELS * 1.1);
